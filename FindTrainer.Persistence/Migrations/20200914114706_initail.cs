    ...
    public partial class initail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserFocuses", x => new { x.FocusId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserFocuses_Focuses_FocusId",
                        column: x => x.FocusId,
                        principalTable: "Focuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserFocuses_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserFocuses_UserId",
                table: "ApplicationUserFocuses",
                column: "UserId");
